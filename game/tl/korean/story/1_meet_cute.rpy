...
translate korean meet_cute_606910ca:
    ...
    "셔츠를 세탁기에 던져넣는 대신 하얀 비누로 박박 닦았지만, 직접 얼룩을 지우는 일이 여간 쉬운 일은 아니었습니다. 그래도 다행히 다시 새것처럼 깨끗해졌네요."
...
translate korean meet_cute_b342a98b:
    ...
    "호기심과 의아함 사이에 당신은 조심스레 창 밖을 내다봅니다."
...
translate korean meet_cute_196d2c9c:
    ...
    "이상한 일임에도 불구하고, 소년이 부르는 듯한 즐거운 콧노래는 위험하게 들리진 않았습니다. 출처가 불분명한 건 좀 오싹할 수도 있지만요."
...
translate korean meet_cute_8eb40183:
    ...
    "어디서 들려오는 건 지 콕집어 말하기 어렵습니다. 당신은 소리가 들려오는 것 같은 방향으로 살금살금 다가갑니다."
...
translate korean meet_cute_e6d3035d:
    ...
    "호기심에 눈썹을 들썩이지만, 이 작은 친구에게서 방치된 흔적을 발견하자 입꼬리가 살짝 내려갑니다."
...
translate korean meet_cute_3bb3e8b8:
    ...
    "그렇게 바닥에 떨어진 종이학을 집어들기 직전, 무언가 느껴집니다."
...
translate korean meet_cute_d676383b:
    ...
    "곧바로 시선이 창가 쪽에 꽂힙니다. 창문보다는 창틀의 모서리부분, 커튼이 걸려있는 곳에요.  기다란 커튼은 바닥에 그림자를 투영하고 있습니다. "
...
translate korean meet_cute_2c696219:
    ...
    "당신은 커튼 뒤의 인물에게 그림자가 없다는 걸 깨닫습니다. 구겨져 엉망인 종이학도 가지고 있는 것을요. 조금 더 유심히 살피자, 사람이라고 부를 수 있을지 모르겠는 것이 가만히 있음을 발견합니다."
...
translate korean meet_cute_1ad6a1c0:
    ...
    "문제를 해결할 수 있는 방법은 여러가지잖아요. 외면은 좋은 선택지가 아니라고들 하지만, 당신은 고대로 선택할 예정입니다. "
...
translate korean meet_cute_bc8af4ae:
    ...
    "무책임한 사람이 되고 싶은 건 아니지만, 하루는 이제 막 시작했고, 말끔한 정신과 새 삶을 위해 그대로 두는 게 나아보입니다."
...
translate korean meet_cute_9c39ef1a:
    ...
    "당신은 마저 하던 일로 돌아갑니다. 옷장 속에 옷을 모두 가지런히 정리해두자 정오의 그림자가 드리워집니다. 걱정되어서, 아님 호기심에 도로 불청객이 있던 창가 쪽으로 시선을 돌립니다."
...
translate korean meet_cute_4019a4f4:
    ...
    "잠시간 뒤적거리기를, 어둠 속에서 가늘게 빛을 반사하는 것을 발견합니다. 가늘지만 날이 잘 드는 칼의 손잡이를 잡고는, 범죄자가 숨어있는 창가로 도로 향합니다."
...
translate korean meet_cute_6d76e039:
    ...
    "물론 이정도로 충분할 겁니다. 당신은 그 무엇도 자극할 필요가 없고, 애초에 그럴 생각도 없었잖아요."

# game/story/1_meet_cute.rpy:117
translate korean meet_cute_50912e28:

    # "Self-defense. That's all. And you're safe."
    "정당방위. 그뿐입니다. 이제 당신은 안전합니다."
