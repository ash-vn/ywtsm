...
translate korean meet_cute_63c4c84c:
    ...
    "상자를 열자 풀풀 나오는 먼지에 당신은 가볍게 콜록거립니다. 아침 햇살 아래 작은 입자들이 가볍게 부유하고 있습니다."
...
translate korean meet_cute_8291b596:
    ...
    "당신은 평범한 와이셔츠 한 장을 꺼내어 세세히 살펴봅니다. 새하얗지만, 약간의 손길이 필요하겠네요."
...
translate korean meet_cute_606910ca:
    ...
    "셔츠를 세탁기에 던져넣는 대신 하얀 비누로 박박 닦았지만, 직접 얼룩을 지우는 일은 여간 어려운 일이 아니었습니다. 그래도 다행히 다시 새것처럼 깨끗해졌네요."
...
translate korean meet_cute_b342a98b:
    ...
    "호기심과 경계 사이에서 당신은 조심스레 창밖을 내다봅니다."
...
translate korean meet_cute_196d2c9c:
    ...
    "소년이 부르는 듯한 즐거운 콧노래는 이상하게도 위험하게 들리진 않았습니다. 출처가 불분명한 게 좀 오싹할 수도 있지만요."
...
translate korean meet_cute_8eb40183:
    ...
    "어디서 들려오는 건지 콕 집어 말하기 어렵습니다. 당신은 소리가 들려오는 것 같은 방향으로 살금살금 다가갑니다."
...
translate korean meet_cute_01a883fe:
    ...
    "소리의 출처를 찾은 건 아닙니다. 대신, 거의 밟을 뻔한 종이 모형을 발견했네요. 아니, 조금 밟힌 것 같기도 하고. 그래요, 날개 끝을 조금 밟아버렸습니다."
...
translate korean meet_cute_d676383b:
    ...
    "곧바로 시선이 창가 쪽에 꽂힙니다. 창문보다는 창틀의 모서리 부분, 커튼이 걸려있는 곳에요. 기다란 커튼은 바닥에 그림자를 투영하고 있습니다."
...
translate korean meet_cute_7d24b69f:
    ...
    "종이가 바스락거리는 소리에 긴장합니다. 당신은 혼자가 아니에요. 그것만은 분명합니다. 운이 아주 나쁜 절도범이나 잡범인가 보죠."
...
translate korean meet_cute_b7e710b6:
    ...
    "커튼 뒤에 숨은 멍청이를 끌어내기 위해 다시 가까이 다가가지만, 시선이 절로 바닥으로 향합니다. 눈 앞에 펼쳐진 광경에 몸이 굳고 숨을 참습니다."

# game/story/1_meet_cute.rpy:42
translate korean meet_cute_31cc48cd:

    # "It's nothing horrible or gruesome. No, it's about a shadow, or rather the lack of it."
    "무섭거나 끔찍한 걸 발견해서가 아닙니다. 이건, 그림자 존재 여부에 대한 문제예요."
...
translate korean meet_cute_2c696219:
    ...
    "당신은 커튼 뒤의 인물에게 그림자가 없다는 걸 깨닫습니다. 초라하게 구겨진 종이학마저 가지고 있는 것을요. 조금 더 유심히 살피자, 사람이라고 불러도 될 지 모르겠는 것이 가만히 있음을 발견합니다."
...
translate korean meet_cute_4371d08c:
    ...
    "그거 알아요? 당신은 지금 침입자를 상대할 기분이 아니라는 거."
...
translate korean meet_cute_1ad6a1c0:
    ...
    "문제를 해결할 수 있는 방법은 여러 가지잖아요. 외면은 좋은 선택지가 아니라고들 하지만, 당신은 그대로 고를 겁니다."
...
translate korean meet_cute_bc8af4ae:
    ...
    "대책 없는 사람이 되고 싶은 건 아니지만, 오늘 하루는 이제 겨우 시작했고, 건강한 정신과 새 삶의 방향성을 위해 그대로 두는 게 나아 보입니다."
...
translate korean meet_cute_9c39ef1a:
    ...
    "당신은 마저 하던 일로 돌아갑니다. 옷장 속에 옷을 모두 가지런히 정리해 두자, 정오의 그림자가 드리워집니다. 근심 혹은 호기심에 도로 불청객이 있던 창가 쪽으로 시선을 돌립니다."
...
translate korean meet_cute_26d31f1e:
    ...
    "당신은 ‘그것’을 찾기 위해 침착하게 ‘그’ 상자를 찾아 엽니다."
...
translate korean meet_cute_4019a4f4:
    ...
    "잠시간 뒤적거리던 중에 어둠 속에서 반사되는 가는 빛을 발견합니다. 얇지만 날이 잘 드는 칼의 손잡이를 잡고는, 다시 범죄자가 숨어있는 창가로 향합니다."
...
translate korean meet_cute_6d76e039:
    ...
    "물론 이 정도로 충분할 겁니다. 당신은 그 무엇도 자극할 필요가 없고, 애초에 그럴 생각도 없었잖아요."

# game/story/1_meet_cute.rpy:117
translate korean meet_cute_50912e28:

    # "Self-defense. That's all. And you're safe."
    "정당방위. 그뿐입니다. 그리고 이제 당신은 안전합니다."
...
translate korean meet_cute_212a22cb:
    ...
    "힘을 싣는다면 얇은 커튼의 뒤편 정도는 반으로 가를 수 있을 겁니다."
